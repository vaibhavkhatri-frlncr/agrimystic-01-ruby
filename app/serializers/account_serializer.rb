class AccountSerializer < BaseSerializer
  attributes :type, :first_name, :last_name, :full_name, :country_code, :phone_number, :full_phone_number, :email, :date_of_birth, :address, :state, :district, :village, :pincode, :activated
