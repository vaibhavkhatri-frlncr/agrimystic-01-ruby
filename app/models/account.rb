class Account < ApplicationRecord
  ...
  validate  :validate_account_names
  validate  :validate_account_phone_number
  validate  :validate_account_profile_image
  ...
  def validate_account_phone_number
    return if full_phone_number.blank?
  ...
  def validate_account_profile_image
